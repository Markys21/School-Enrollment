...
<html lang="en">
      ...
      <div class="container">
			...
			<div class="container">
				<div class="row">
	          	...
	          	<h2 class="mb-4">MISSION</h2>
							<p>The mission of our Christian School is to transform this generation through sound academic education with a distinct Christian worldview. We are committed to transferring our passion for serving Christ to our students for their benefit and for the glory of God.</p>
						<h2 class="mb-4">VISION</h2>
							<p>The vision of our Christian School is to provide a comprehensive educational facility that will accommodate a life-developing curriculum and graduate students who express a passionate faith, a biblical world view philosophy and are practitioners of true Christianity.</p>
    	...
    	<div class="container">
          ...
          <div class="col-md-8 text-center heading-section heading-section-black ftco-animate">
            <h2 class="mb-4"><span>19 Years of</span> Experience</h2>
  ...
  <?php
  include 'db_conn.php';
  $sql = mysqli_query($conn, "SELECT * FROM users WHERE status = 1 AND assigned = 'assigned'");
  $totalRows = mysqli_num_rows($sql); // Get the total number of rows

  echo '<strong class="number" data-number="' . $totalRows . '">0</strong>';
  echo '<span>Certified Teachers</span>';
  ?>
</div>
		          ...
		          <div class="col-md d-flex justify-content-center counter-wrap ftco-animate">
		            <div class="block-18">
					  ...
					  <?php
  include 'db_conn.php';
  $sql = mysqli_query($conn, "SELECT * FROM tblstudent WHERE status = 0");
  $totalRows = mysqli_num_rows($sql); // Get the total number of rows

  echo '<strong class="number" data-number="' . $totalRows . '">0</strong>';
  echo '<span>Official Enrolled</span>';
  ?>
		          ...
		          <div class="col-md d-flex justify-content-center counter-wrap ftco-animate">
		            <div class="block-18">
		              ...
		              <?php
  include 'db_conn.php';
  $sql = mysqli_query($conn, "SELECT * FROM tblevents WHERE status = 1");
  $totalRows = mysqli_num_rows($sql); // Get the total number of rows

  echo '<strong class="number" data-number="' . $totalRows . '">0</strong>';
  echo '<span>CHCA Total Subjects</span>';
  ?>
		              </div>
		            </div>
		          </div>
		          <div class="col-md d-flex justify-content-center counter-wrap ftco-animate">
		            <div class="block-18">
					  ...
					  <?php
  include 'db_conn.php';
  $sql = mysqli_query($conn, "SELECT * FROM tblstudent WHERE status = 1");
  $totalRows = mysqli_num_rows($sql); // Get the total number of rows

  echo '<strong class="number" data-number="' . $totalRows . '">0</strong>';
  echo '<span>New Enrollees</span>';
  ?>
		              </div>
		            </div>
		          </div>
