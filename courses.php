...
$sql = mysqli_query($conn, "SELECT * FROM tblevents WHERE status = 1 AND courseyear = '1st year' ORDER BY id DESC LIMIT $startFrom, $recordsPerPage");

// Query to count total records
$totalRecords = mysqli_query($conn, "SELECT COUNT(*) AS total FROM tblevents WHERE status = 1 AND courseyear = '1st year'");
$totalRecords = mysqli_fetch_assoc($totalRecords)['total'];

// Search functionality
$search = isset($_GET['search']) ? $_GET['search'] : '';
if (!empty($search)) {
    $sql = mysqli_query($conn, "SELECT * FROM tblevents WHERE status = 1 AND courseyear = '1st year' AND EventName LIKE '%$search%' ORDER BY id DESC LIMIT $startFrom, $recordsPerPage");
    $totalRecords = mysqli_query($conn, "SELECT COUNT(*) AS total FROM tblevents WHERE status = 1 AND courseyear = '1st year' AND EventName LIKE '%$search%'");
    $totalRecords = mysqli_fetch_assoc($totalRecords)['total'];
}
            ...
            <div class="col-md-12">
                <div class="search-container mb-4">
                    <form action="" method="GET">
                        <input type="text" placeholder="Search by event name" name="search" value="<?php echo $search; ?>">
            ...
            <?php while ($row = mysqli_fetch_assoc($sql)) { ?>
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="card staff">
                        <img class="card-img-top" src="../images/<?php echo $row['featuredimage'] ?>" alt="Event Image">
                        <div class="card-body">
